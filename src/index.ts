...
export default class ElectronWindowKeeper {
    ...
    public restoredState: Partial<Rectangle & { fullscreen: boolean; }>;
    /** Including maximized */
    public restoredFullState: Partial<Rectangle & Record<(typeof propsToPreserve["boolean"])[number], boolean>>;
